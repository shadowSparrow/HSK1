...
class DataManager {
    ...
    var characters = [
        CharacterData(character: "爱", pingYing: "ài", translation: "любить, любовь, любимый", examples: [
       ...
       CharacterData(character: "八", pingYing: "bā", translation: "восемь, восьмой, разделять", examples: [
        ...
        CharacterData(character: "爸爸", pingYing: "bàba", translation: "папа, тятя, отец", examples: [
